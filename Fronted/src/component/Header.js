                        ...
                        <div className="relative text-[var(--text-white)]  py-3 w-full hidden md:block" ref={menuRef}>
                            ...
                            <div className="overflow-x-auto custom-scrollbar">
                                <div className="flex justify-between items-center min-w-max w-full">
                                    ...
                                    {/* Fashion */}
                                    <div className="cursor-pointer flex items-center gap-2 shrink-0 px-2" onClick={() => toggleMenu("fashion")}>
                                        Fashion
                                        {openMenu === "fashion" ? (
                                            <FaAngleUp className="text-sm text-[var(--header-text-orange)]" />
                                        ) : (
                                    ...
                                    <div className="cursor-pointer flex items-center gap-2 shrink-0 px-2">
                                        Electronics <FaAngleDown className="text-sm" />
                                    </div>
                                    <div className="cursor-pointer flex items-center gap-2 shrink-0 px-2">
                                        Mobile &amp; Tablets <FaAngleDown className="text-sm" />
                                    </div>
                                    <div className="cursor-pointer flex items-center gap-2 shrink-0 px-2">
                                        Beauty <FaAngleDown className="text-sm" />
                                    </div>
                                    <div className="cursor-pointer flex items-center gap-2 shrink-0 px-2">
                                        Personal Care <FaAngleDown className="text-sm" />
                                    </div>
                                    <div className="cursor-pointer flex items-center gap-2 shrink-0 px-2 ">
                                        Grocery <FaAngleDown className="text-sm" />
                                    </div>
                                    <div className="cursor-pointer flex items-center gap-2 shrink-0 px-2  xl:ps-0">
                                        Deal <FaAngleDown className="text-sm" />
                                    </div>
                                </div>
                            </div>
                            ...
                            {openMenu === "home" && (
                                <div className="absolute left-0 top-full w-full bg-[var(--bg-white)] shadow-lg z-[90]">
                                    <div className="max-w-7xl min-w-full px-6 py-6 flex gap-6">
